        ...
        <div className="space-y-12">
          <section className="bg-white rounded-2xl p-8 md:p-10 border border-border shadow-sm">
            ...
            <div className="space-y-4 text-slate-600 leading-relaxed">
              <p>
                Sarkar Watch is an independent, citizen-driven initiative designed to track the election promises made by the United Democratic Front (UDF) in Kerala. Our goal is to foster civic engagement and hold elected representatives accountable to their manifesto commitments.
              </p>
              <p>
          ...
          <section className="bg-white rounded-2xl p-8 md:p-10 border border-border shadow-sm">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-slate-600">No. Sarkar Watch is strictly an independent, non-partisan citizen initiative. We are not affiliated with the Election Commission of India, the Government of Kerala, or the UDF.</p>
              </div>
              <div>

        ...
        <>
          ...
          >
              ...
              <div className="flex items-center gap-4">
                {hasActiveFilters && (
                  <button
                    ...
                    className="flex items-center gap-1 text-xs font-bold text-red-500 hover:text-red-600 transition-colors py-1 px-2 hover:bg-red-50 rounded-lg"
                  >
                ...
                <button
                  onClick={onClose}
                  className="p-1.5 bg-slate-100 text-slate-500 hover:text-slate-700 rounded-full transition-colors"
            ...
            <div className="p-6 border-t border-slate-100 bg-white rounded-b-3xl shrink-0">
              <button
                onClick={onClose}
                className="w-full py-3 bg-udf-blue hover:bg-udf-blue-dark text-white rounded-xl font-bold text-sm shadow-md hover:shadow-lg transition-all text-center cursor-pointer"
              >
